...
export const YOUTUBE_SEARCH_QUERY = `https://youtube.googleapis.com/youtube/v3/search?key=${process.env.REACT_APP_GOOGLE_API_KEY}&type=video&maxResults=50&part=snippet&q=`